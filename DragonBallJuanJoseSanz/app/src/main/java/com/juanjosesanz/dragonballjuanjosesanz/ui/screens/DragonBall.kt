...
fun DragonBall() {
    ...
    val dbChar = DragonBallCharacter
    Scaffold(
        ...
        Row(
            ...
            Box() {
                Row {
                    LazyColumn {
                        val groupedCharacter: Map<Char, List<DragonBallCharacter>> =
                            dbChar.sorted().groupBy { it.spanishName.first() }
                        Log.i("--->", groupedCharacter.toString())
                        groupedCharacter.forEach { header, group ->
                            stickyHeader {
                                Text(
                                    text = "$header",
